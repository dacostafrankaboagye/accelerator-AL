...
public class MessageDecoratorExample {
    public static void main(String[] args) {
        ...
        System.out.println("Encrypted Message Content: " + encryptedMessage.getContent());
        ...
        System.out.println("Compressed Message Content: " + compressedMessage.getContent());
        ...
        System.out.println("Secure Compressed Message Content: " + secureCompressedMessage.getContent());
        ...
        System.out.println("Compressed Secure Message Content: " + compressedSecureMessage.getContent());
